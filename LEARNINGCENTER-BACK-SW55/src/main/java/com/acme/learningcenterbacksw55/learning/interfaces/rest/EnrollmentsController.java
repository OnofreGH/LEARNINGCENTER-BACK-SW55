...
import com.acme.learningcenterbacksw55.learning.domain.model.commands.CancelEnrollmentCommand;
import com.acme.learningcenterbacksw55.learning.domain.model.commands.ConfirmEnrollmentCommand;
import com.acme.learningcenterbacksw55.learning.domain.model.commands.RejectEnrollmentCommand;
import com.acme.learningcenterbacksw55.learning.domain.model.queries.GetAllEnrollmentsQuery;
import com.acme.learningcenterbacksw55.learning.domain.model.queries.GetEnrollmentByAcmeStudentRecordIdAndCourseIdQuery;
import com.acme.learningcenterbacksw55.learning.domain.model.valueobjects.AcmeStudentRecordId;
import com.acme.learningcenterbacksw55.learning.domain.services.EnrollmentCommandService;
...
import com.acme.learningcenterbacksw55.learning.interfaces.rest.transform.EnrollmentResourceFromEntityAssembler;
import com.acme.learningcenterbacksw55.learning.interfaces.rest.transform.RequestEnrollmentCommandFromResourceAssembler;
import com.acme.learningcenterbacksw55.shared.interfaces.rest.resources.MessageResource;
...
public class EnrollmentsController {
    ...
    public ResponseEntity<EnrollmentResource> requestEnrollment(@RequestBody RequestEnrollmentResource resource) {
        ...
        var getEnrollmentByAcmeStudentRecordIdAndCourseIdQuery =
                new GetEnrollmentByAcmeStudentRecordIdAndCourseIdQuery(new AcmeStudentRecordId(resource.studentRecordId()), resource.courseId());
